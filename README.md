...
```sh
  cd my-folder
  git clone https://github.com/sahlminkok/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/sahlminkok/hello-rails-back-end/issues).
